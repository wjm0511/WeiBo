...
public class C {
    ...
    public static final class api{
        public static final String base="http://192.168.0.137:8001";
    ...
    public static final class intent{
        public static final class action{
            public static final String EDITTEXT="com.example.wjm.weibo.EDITTEXT";
            public static final String EDITBLOG="com.example.wjm.weibo.EDITBLOG";
        }
    }
    ...
    public static final class web{
        public static final String base="http://192.168.0.137:8002";
